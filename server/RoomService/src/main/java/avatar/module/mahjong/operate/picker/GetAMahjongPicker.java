 ...
 */
public class GetAMahjongPicker implements PersonalMahjongInfoPicker {
    private static final GetAMahjongPicker instance = new GetAMahjongPicker();

    public static GetAMahjongPicker getInstance() {
        return instance;
    }
