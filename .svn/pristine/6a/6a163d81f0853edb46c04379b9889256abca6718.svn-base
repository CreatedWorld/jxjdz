...
public class NotificationConstant
{
    ...
    /// 场景切换完成
    /// </summary>
    public const string MEDI_GAMEMGR_SCENE_CHANGED = "MEDI_GAMEMGR_SCENE_CHANGED";
    /// <summary>
    /// 创建房间跳场景
    /// </summary>
    ...
    /// 初始化排行消息
    /// </summary>
    public const string MEDI_HALL_INITRANKINGINFO = "MEDI_HALL_INITRANKINGINFO";
    /// <summary>
    /// 获取排行信息
    /// </summary>
    public const string MEDI_HALL_GETINFO = "MEDI_HALL_GETINFO";
    /// <summary>
    /// 从服务器获取排行信息
    /// </summary>
    public const string MEDI_HALL_GETRANKINGINFO = "MEDI_HALL_GETRANKINGINFO";
    /// <summary>
    /// 报名成功消息
    /// </summary>
    ...
    /// 刷新比赛场信息
    /// </summary>
    public const string MEDI_HALL_REFRESHATHLETICSVIEW = "MEDI_HALL_REFRESHATHLETICSVIEW";
    /// <summary>
    /// 刷新大厅玩家信息
    /// </summary>
    ...
    /// 刷新玩家信息
    /// </summary>
    public const string MEDI_PLAYINFO_REFRESHUSERINFO = "MEDI_PLAYINFO_REFRESH";
    //战斗模块消息
    /// <summary>
    /// 听牌变更
    /// </summary>
    ...
    /// 更新房间消息
    /// </summary>
    public const string MEDI_BATTLE_UPDATEOOMMESSAGES = "MEDI_BATTLE_UPDATEOOMMESSAGES";
    /// <summary>
    /// 播放玩家胡牌
    /// </summary>
    ...
    /// 播放出花牌
    /// </summary>
    public const string MEDI_BATTLE_PLAYPUTFLOWERCARD = "MEDI_BATTLE_PLAYPUTFLOWERCARD";
    /// <summary>
    /// 隐藏录音中标志
    /// </summary>
    ...
    /// 显示开局的精牌
    /// </summary>
    public const string MEDI_BATTLE_SHOWJING = "MEDI_BATTLE_SHOWJING";
    /// <summary>
    /// 显示单局结算界面
    /// </summary>
    ...
    public const string MEDI_HALL_RANKINGIFON = "MEDI_HALL_RANKINGIFON";

    public const string MEDI_BATTLE_PLAYROTATE = "";
    public const string MEDI_BATTLEVIEW_UPDATEONLINE = "";
    public const string MEDI_BATTLEVIEW_INITPLAYERCARDS = "";
    public const string MEDI_BATTLEVIEW_UPDATEVOLUME = "";
}
...
public class Mediators
{
    ...
    /// 登陆
    /// </summary>
    public const string LOGIN_MEDIATOR = "LOGIN_MEDIATOR";
    /// <summary>
    /// 大厅
    /// </summary>
    public const string HALL_CUSTOMERSERVICE = "HALL_CUSTOMERSERVICE";
    public const string HALL_MEDIATOR = "HALL_MEDIATOR";
    public const string HALL_ACTIVITY = "HALL_ACTIVITY";
    public const string HALL_COMPETITION = "HALL_COMPETITION";
    public const string HALL_GRADE = "HALL_GRADE";
    public const string HALL_GRADEINFO = "HALL_GRADEINFO";
    ...
    public const string HALL_RANKING = "HALL_RANKING";
    public const string HALL_ATHLETICS = "HALL_ATHLETICS";
    /// <summary>
    /// 战斗UI代理
    /// </summary>
