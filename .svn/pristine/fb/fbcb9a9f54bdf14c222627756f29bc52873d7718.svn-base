...
{
    public SignInMediator(string NAME, object viewComponent):base(NAME,viewComponent)
    {
    }
    ...
    {
        base.OnRemove();
        UIManager.Instance.DestroyUI(UIViewID.SIGNIN_VIEW);
    }
    ...
    private void SendSignInMsg()
    {
        ...
        NetMgr.Instance.SendBuff<CheckInC2S>(SocketType.HALL, MsgNoC2S.REQUEST_USERSIGNIN_C2S.GetHashCode(), 0, package);
    }
    ...
    private void SendGetCardMsg()
    {
        ...
        NetMgr.Instance.SendBuff<GetCardInfoC2S>(SocketType.HALL, MsgNoC2S.REQUEST_GETCHECKINREWARD_C2S.GetHashCode(),0,package);
    }
}
