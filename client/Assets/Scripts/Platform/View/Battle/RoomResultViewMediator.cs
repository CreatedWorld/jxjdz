...
namespace Platform.View.Battle
{
    ...
    internal class RoomResultViewMediator : Mediator, IMediator
    {
        ...
        public override void OnRegister()
        {
            ...
            View.goonBtn.onClick.AddListener(OnCloseClick);
        ...
        private void InitUI()
        {
            ...
            View.roomIdTxt.text ="房间："+hallProxy.HallInfo.RoomCode;
            View.timeTxt.text = gameMgrProxy.systemDateTime.ToString("yyyy-MM-dd HH:mm");
            View.numberTxt.text = string.Format("剩余  {0}/{1} 局", battleProxy.curInnings, hallProxy.HallInfo.Innings);
